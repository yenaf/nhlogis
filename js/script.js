...
function main_visual() {
  let arrh2 = [];
  arrh2[0] =
    'Farm to Table<br><span>원산지 그대로의 신선함</span>을<br> 농협물류가 전달합니다.';
  arrh2[1] =
    '우리의 것<br><span>우리 농수산물</span><br>농협물류가 함께합니다.';
  arrh2[2] =
    '<span>농업, 농촌, 국민</span>과<br>함께하는 농협<br>농협물류가 앞장서겠습니다.';
...
function con_system() {
  ...
  let arrp = [];
  arrp[0] =
    '주문관리, 입/출고 데이터관리, 재고관리 등 정확하고 체계적인 창고관리 시스템을 통한 물류센터의 효율적 운영';
  arrp[1] =
    '물류자원, 배송루트관리등 효율적인 배송시스템 구축.  고객주문정보를 바탕으로 배송량 집계 및 운송 계획을 수립. 효율적인 배차지시와 운송과정을 관리하고 고객에게 배송현황을 지원하는 시스템';
  arrp[2] =
    '물류배송 차량 관제 및 배송현황 모니터링 지원시스템. 물류배송차량을 실시간으로 관제함으로써 기업의 인적, 물적자원을 효율적으로 운용하기위한 시스템';
  let imgurl = '',
    idx = 0,
    timer = null,
    interval = 4000;
